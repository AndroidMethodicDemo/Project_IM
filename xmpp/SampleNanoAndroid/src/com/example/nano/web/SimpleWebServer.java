...
import com.example.nano.web.NanoHTTPD;
import com.example.nano.web.ServerRunner;
...
public class SimpleWebServer extends NanoHTTPD {
    ...
    public static void main(String[] args) {
        ...
        simpleWebServer = new SimpleWebServer(host, port, rootDirs, quiet);
        ServerRunner.executeInstance(simpleWebServer);
    }
    public static void stopServer(){
    	ServerRunner.stopInstance(simpleWebServer);;
    }
