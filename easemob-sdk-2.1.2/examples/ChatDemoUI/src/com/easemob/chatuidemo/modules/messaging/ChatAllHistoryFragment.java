...
import com.easemob.chatuidemo.modules.main.MainActivity;

/**
 * 显示所有会话记录，比较简单的实现，更好的可能是把陌生人存入本地，这样取到的聊天记录是可控的
 * [搜索框
 * [会话列表
 * 	1. loadConversationsWithRecentChat 获取会话列表
 * 	2. listView.setOnItemClickListener 点击事件
 * 	3. onCreateContextMenu 长按ListView
 * 	4. sortConversationByLastChatTime，对会话进行排序
 * 	5. onHiddenChanged，第一次接触，值得学习
 * [零碎知识
 * 1. InputMethodManager			隐藏软件盘
 * 2. AdapterContextMenuInfo	ListView的上下文菜单
 * 
 */
...
/*		listView.setOnLongClickListener(new OnLongClickListener() {
	...
	/**
	 * 从用户体验来讲，不如使用ListView的onItemLongClick
	 */
	@Override
